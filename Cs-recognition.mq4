...
#property copyright "Copyright © 2020, ForexPractical"
...
//  added by RaptorUK
extern bool Display_Engulfing = true;
extern bool Show_Engulfing_Alert = true;
extern color Color_Engulfing = Aqua;
...
"\n", "Eng       - Engulfing Pattern");
   ...
   double CL, CLmin, CL1, CL2, BL, BLa, BL90, BL1, BL2, UW, UWa, UW1, UW2, LW,  BodyHigh, BodyLow;
   BodyHigh = 0;
   BodyLow = 0;
     ...
     // Check for Morning Star
      ...
      if ( ( ( C > MathMax(O1, C1) && O < MathMin(O1, C1) ) || ( O > MathMax(O1, C1) && C < MathMin(O1, C1) ) )  && ( CL >= (Engulfing_Length*Pip) ) ) 
         ...
         if (Display_Engulfing) 
            {   
            ObjectCreate(GetName("Eng",shift), OBJ_TEXT, 0, Time[shift1], NormalizeDouble(Low[shift1],RoundTo) - (Pointer_Offset+Offset_Bullish_Engulfing+CumOffset)*Pip);
 ...
 // End of Bullish Patterns          
      if (setalert == 1 && shift == 0) {
         string alerts = Symbol() + " " + period + " " + pattern;
